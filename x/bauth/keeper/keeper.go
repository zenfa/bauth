...
// NewKeeper creates a bauth keeper
func NewKeeper(coinKeeper bank.Keeper, accKeeper auth.AccountKeeper, cdc *codec.Codec, key sdk.StoreKey) Keeper {
	keeper := Keeper{
