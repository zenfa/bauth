...
import (
	...
	"github.com/zenfa/bauth/x/bauth/client/cli"
	"github.com/zenfa/bauth/x/bauth/client/rest"
...
func NewAppModule(k keeper.Keeper, bankKeeper bank.Keeper, authKeeper auth.AccountKeeper) AppModule {
	return AppModule{
